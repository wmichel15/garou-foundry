...
This repository contains a Foundry VTT module that adds a homebrew **Garou** class and related content (tribes, gifts, rites, and lore) for D&D 5e. Requires Foundry VTT v13. Compatible with dnd5e.
