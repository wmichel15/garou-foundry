...
const WILD_INSPIRATION_KEY = "wildInspiration";
const URBAN_ADAPTATION_KEY = "urbanAdaptation";
const APEX_INSTINCT_KEY = "apexInstinct";
const RIDER_BASE_KEYS = [TRIAL_BY_COMBAT_KEY, REGAL_BEARING_KEY, OATH_OF_VENGEANCE_KEY, MANTLE_OF_DREAD_KEY, VOICE_OF_CALM_KEY, SCRAPPERS_CUNNING_KEY, WILD_INSPIRATION_KEY, URBAN_ADAPTATION_KEY, APEX_INSTINCT_KEY];
